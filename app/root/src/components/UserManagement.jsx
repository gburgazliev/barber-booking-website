...
const UserManagement = () => {
  ...
  const fetchUserAppointments = async (userId) => {
    try {
      ...
      const response = await fetch(SERVER_URL(`api/admin/users/${userId}/appointments`), {
        credentials: 'include'
      });
      ...
      addAlert(`Error loading user appointments: ${error.message}`, ALERT_TYPES.ERROR);
    } finally {
          ...
          <div className="card-body">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div>
                ...
                <p><span className="font-semibold">Name:</span> {`${selectedUser.firstname} ${selectedUser.lastname}`}</p>
              ...
              <div>
                ...
                <div className="flex items-center mt-2">
                  <div className={`badge ${selectedUser.role === 'admin' ? 'badge-primary' : 'badge-success'} mr-2`}>
                    Active
                  </div>
                </div>
              </div>
