...
const Calendar = () => {
  ...
  return (
    <div className="border bg-red-50 rounded-lg shadow-lg  shadow-black self-start flex sm:flex-col p-0 m-0 md:flex-row md:p-5 m-5 lg:flex-row lg:p-5 lg:m-5 xl:flex-row xl:p-5 xl:m-5">
      <div>
